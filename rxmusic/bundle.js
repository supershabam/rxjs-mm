...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymovements = __webpack_require__(1);

	var _keymovements2 = _interopRequireWildcard(_keymovements);

	var _midikeyboard = __webpack_require__(6);

	var _midikeyboard2 = _interopRequireWildcard(_midikeyboard);
	...
	var km = _keymovements2['default'](document);
	var kb = _midikeyboard2['default'](km);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function keymovements(el) {
	  var active = new Set();

	  var keydowns = _rx2['default'].Observable.fromEvent(el, 'keydown').pluck('which');
	  var keyups = _rx2['default'].Observable.fromEvent(el, 'keyup').pluck('which');
	  // latched is once a keydown is triggered, it won't fire again until
	  // manually unlatched (removing it from active)
	  var latchedKeydowns = keydowns.filter(function (which) {
	    return !active.has(which);
	  })['do'](function (which) {
	    active.add(which);
	  });
	  var unlatchingKeyups = keyups['do'](function (which) {
	    active['delete'](which);
	  });

	  return _rx2['default'].Observable.merge(latchedKeydowns.map(toMovement('down')), unlatchingKeyups.map(toMovement('up')));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5)(module), (function() { return this; }()), __webpack_require__(4)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseMIDINote = 60;
	// in-order keys
	var keyboard = 'AWSEDFTGYHJIKOL';
	// keymap turns a keyboard key into a midi note
	var keymap = new Map([].map.call(keyboard, function (c, i) {
	  return [c.charCodeAt(0), baseMIDINote + i];
	}));
	function midikeyboard(keymovements) {
	  return keymovements.filter(function (movement) {
